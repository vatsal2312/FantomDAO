...
contract sFantomDAO is ERC20Permit, Ownable {
    ...
    constructor() ERC20("DREAM2", "DREAM2", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMAGIC supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMAGIC
